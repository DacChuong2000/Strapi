...
export interface ApiBaotintucBaotintuc extends Schema.CollectionType {
  collectionName: 'baotintucs';
  info: {
    singularName: 'baotintuc';
    pluralName: 'baotintucs';
    displayName: 'baotintuc';
    description: '';
  };
  options: {
  ...
  attributes: {
    loaibao: Attribute.Text;
    thoigianloaibao: Attribute.DateTime;
    tieude: Attribute.String;
    thongtinlienquan: Attribute.RichText;
    chitiethinhanh: Attribute.Text;
    phanloai: Attribute.JSON;
    picture: Attribute.String;
    binhluan: Attribute.JSON;
    tacgiabaibao: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::baotintuc.baotintuc',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
